...
public class MarketView : DbUserControl
{
    ...
    private readonly Button        _btnBuy;
    private readonly Button        _btnSell;
    ...
    public MarketView(MarketSimulator sim, PortfolioService port)
    {
        ...
        _btnBuy  = CreateActionButton("▲  COMPRAR", AppTheme.Green, AppTheme.GreenLight);
        _btnSell = CreateActionButton("▼  VENDER",  AppTheme.Red,   AppTheme.RedLight);
        _btnBuy.Enabled  = false;
        _btnSell.Enabled = false;
        _btnBuy.Click   += OnBuyClick;
        _btnSell.Click  += OnSellClick;
        btnPanel.Controls.Add(_btnBuy,  0, 0);
        btnPanel.Controls.Add(_btnSell, 1, 0);
